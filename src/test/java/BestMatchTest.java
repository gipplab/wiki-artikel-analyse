...
import textjudger.Match;
import textjudger.Matcher;
...
public class BestMatchTest {
	 ...
	 @Test
	    public void compareMovedStrings() throws Exception
	    {
		 	...
		 	String[] s1 = "Do testing. Test these matches. Ipsum Lorem.".split(" ");
		 	String[] s2 = "Test these matches. Do testing. Ipsum Lorem.".split(" ");
	 ...
	 @Test
	    public void compareThreeRevisions() throws Exception
	    {
		 	...
		 	String[] s2 = "Ipsum Lorem. Do testing.".split(" ");
		 	String[] s3 = "Do something new. Ipsum Lorem. Do testing.".split(" ");
